  ...
  <Demo title="">
    <ItemGrid0 columns={4} class="bg-stripe">
      <Card1
        ...
        badgeBottomLeft="BL"
        classes={{
          badgeTopRight: 'text-red-700 font-semibold text-sm border p-1 rounded', 
          badgeBottomRight: 'text-amber-500 font-semibold text-sm border p-1 rounded', 
          badgeBottomLeft: 'text-blue-700 font-semibold text-sm border p-1 rounded'
        }}
      >
        <Fragment slot="badge">
