...
<div className="overflow-x-auto">
  <div className="min-w-xl">
    ...
    | `callToAction` | [ICallToAction](/docs/types#icalltoaction) | - | Action button or link. See the [button](/docs/button) component for details.  |
    ...
    | `data` | [INameValue](/docs/types#inamevalue) [] | - | Array of data strings |
    | `links` | [ILink](/docs/types#ilink) [] | - | Array of links |
