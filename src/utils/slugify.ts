...
const charMap: CharMap = JSON.parse(
  // The \" sequences are redundant for this single-quoted JS string but are part of the
  // embedded JSON payload (they encode a literal " for the smart-quote entries); leave them.
